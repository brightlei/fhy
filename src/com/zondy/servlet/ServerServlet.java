...
public class ServerServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(session.getAttribute("user")!=null){
			...
			out.println("user.logintime='"+DateUtils.date2String("yyyy-MM-dd HH:mm:ss")+"';");
	...
	public static long checktime(){
		String lasttime = "2019-01-31 00:00:00";
		long endtime = DateUtils.dateString2Date(lasttime, "yyyy-MM-dd HH:mm:ss").getTime();
