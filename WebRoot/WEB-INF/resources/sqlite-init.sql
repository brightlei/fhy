...
create table T_PERSON(
	id integer primary key AUTOINCREMENT NOT NULL,--主键，人员ID
...
create table T_ZHIBIAO(
	id integer primary key AUTOINCREMENT NOT NULL,--主键，自动编号
...
--创建评价指标信息表
create table T_PJZB(
	id integer primary key AUTOINCREMENT NOT NULL,--主键，评价指标编号
...
create table T_FHY(
	...
	cjsj varchar(24) default (datetime('now', 'localtime')),--创建时间
	xgsj varchar(24) default (datetime('now', 'localtime')),--修改时间
	state int default 1 --记录状态:0-已删除，1-正常
);
